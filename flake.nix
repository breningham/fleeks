{
  ...
  outputs = { self, nixpkgs, home-manager, fleek, ... }@inputs: {
    ...
    homeConfigurations = {
      ...
      "bingham@brens-home-pc" = home-manager.lib.homeManagerConfiguration {
        ...
        modules = [
          ...
          ./brens-home-pc/bingham.nix
          ./brens-home-pc/custom.nix
          # self-manage fleek
          {
            home.packages = [
      ...
      "bingham@brens-macbook-pro.local" = home-manager.lib.homeManagerConfiguration {
        ...
        modules = [
          ...
          ./programs.nix
          # Host Specific configs
          ./brens-macbook-pro.local/bingham.nix
          ./brens-macbook-pro.local/custom.nix
          # self-manage fleek
          {
            home.packages = [
